			...
			<table class="wp-list-table widefat fixed pages">
				<tr>
					...
					<td>
						...
						<input type="text" name="newUsertemplateName" size="15" maxlength="20" value="<?php if (isset($_POST['newUsertemplateName'])) { echo $_POST['newUsertemplateName']; } ?>" <?php if (isset($ftpQuestion) && $ftpQuestion) echo disabled; ?>/> <input type="submit" name="createUserTemplate" class="button-primary" value="Benutzertemplate anlegen"  <?php if (isset($ftpQuestion) && $ftpQuestion) echo disabled; ?>/>
					</td>
				</tr>
			</table>
 			...
 			<form name="anmeldeForm" method="post" action="">
				<table class="wp-list-table widefat fixed pages">
					<tr>
						...
						<td><input type="text" name="paFirma" value="<?php if (isset($_POST['paFirma'])) { echo $_POST['paFirma']; } ?>" size="25" maxlength="50" ></td>
					</tr>
					<tr>
						<td>Name, Vorname:</td>
						<td>
							<input type="text" name="paName" value="<?php if (isset($_POST['paFirma'])) { echo $_POST['paName']; } ?>" size="25" maxlength="25">,
							<input type="text" name="paVorname" value="<?php if (isset($_POST['paFirma'])) { echo $_POST['paVorname']; } ?>" size="25" maxlength="25">
						</td>
					</tr>
					<tr>
						<td>Strasse, Nr:</td>
						<td>
							<input type="text" name="paStrasse" value="<?php if (isset($_POST['paFirma'])) { echo $_POST['paStrasse']; } ?>" size="40" maxlength="40">,
							<input type="text" name="paHausnummer" value="<?php if (isset($_POST['paFirma'])) { echo $_POST['paHausnummer']; } ?>" size="6" maxlength="6">
						</td>
					</tr>
					<tr>
						<td>Plz, Ort:</td>
						<td>
							<input type="text" name="paPlz" value="<?php if (isset($_POST['paFirma'])) { echo $_POST['paPlz']; } ?>" size="6" maxlength="6">
							<input type="text" name="paOrt" value="<?php if (isset($_POST['paFirma'])) { echo $_POST['paOrt']; } ?>" size="40" maxlength="40">
						</td>
					</tr>
					<tr>
						<td>Land:</td>
						<td>
							<select name="paLand">
								<option value="DE"<?php if (isset($_POST['paLand']) && $_POST['paLand'] == 'DE') echo " selected"; ?>>Deutschland</option>
								<option value="CH"<?php if (isset($_POST['paLand']) && $_POST['paLand'] == 'CH') echo " selected"; ?>>Schweiz</option>
							</select>
						</td>
					</tr>
					<tr>
						<td>Telefon:</td>
						<td><input type="text" name="paPhone" value="<?php if (isset($_POST['paFirma'])) { echo $_POST['paPhone']; } ?>" size="40" maxlength="50" ></td>
					</tr>
					<tr>
						<td>E-Mail:</td>
						<td><input type="text" name="paMail" value="<?php if (isset($_POST['paFirma'])) { echo $_POST['paMail']; } ?>" size="40" maxlength="50" ></td>
					</tr>
					<tr>
						<td>URL zur Homepage:</td>
						<td><input type="text" name="paUrl" value="<?php if (isset($_POST['paFirma'])) { echo $_POST['paUrl']; } ?>" size="40" maxlength="50" ></td>
					</tr>
					<tr>
						<td>Portrait-Archiv Niederlassung:</td>
						<td>
							<select name="PA_NIEDERLASSUNG">
								<option value="DE"<?php if (isset($paSystemCountry) && $paSystemCountry == 'DE') echo " selected"; ?>>Deutschland (Portrait-Archiv)</option>
								<option value="CH"<?php if (isset($paSystemCountry) && $paSystemCountry == 'CH') echo " selected"; ?>>Schweiz (Portrait-Archiv.ch)</option>
							</select>
						</td>
					</tr>
					<tr>
