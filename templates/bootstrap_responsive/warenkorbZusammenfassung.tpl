...
<form name="warenkorbSubmitForm" method="post" action="<?php echo remove_query_arg('pawps_galerieReset', add_query_arg (array('pawps_shooting'=> $shooting->id, 'pawps_ordner' => null))); ?>">
	<h4>Zahlungsweise</h4>
	<div class="radio">
	  <label>
	...
	<?php
		if ($warenkorb->getGesamtpreis(false) > 0) {
	?>
	<div class="radio">
	  <label>
