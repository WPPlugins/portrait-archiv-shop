...
<div class="row text-center">	
		<img src="<?php echo $image->getDetailUrl(); ?>" class="img-rounded" />

		<form name="warenkorbForm" method="post" action="<?php echo remove_query_arg('pawps_galerieReset', add_query_arg (array('pawps_shooting'=> $shooting->id, 'pawps_ordner' => null))); ?>" class="form-inline">
