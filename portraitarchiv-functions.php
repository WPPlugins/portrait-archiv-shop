<?php
 		...
 		if (!isset($pricelist) || 
 			...
 			$wpdb->insert(
 					...
 					array(
 							...
 							'lastupdate' => $remotePricelistJsonResult->lastUpdate,
 ...
 function pawps_refreshImageList($shootingId, $technicalId) {
 	...
 	$codeElements = explode ( "-", $shootingId );
 ...
 function pawps_is_email(&$address_to_validate, $strict = false) {
 	...
 	$toplevel  = '([a-z]{2,4}|museum|travel|online)';    //.museum and .travel are the only TLDs longer than four signs
